...
public class UsuarioListProviderActivity extends FragmentActivity {
	AQuery aq;
	RowAdapter listado;
	Menu menu;
	...
	public void consultar() {
		...
		String[] projection = new String[] { "_ID", Usuario.COL_NOMBRE,
				Usuario.COL_TELEFONO, Usuario.COL_EMAIL };
