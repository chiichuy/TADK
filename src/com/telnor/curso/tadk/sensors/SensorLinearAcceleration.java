...
public class SensorLinearAcceleration extends Activity implements
		SensorEventListener {
	...
	private final Handler linearEventHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			((TextView) findViewById(R.id.linearxtext)).setText(data
					.getString("x"));
			((TextView) findViewById(R.id.linearytext)).setText(data
					.getString("y"));
			((TextView) findViewById(R.id.linearztext)).setText(data
					.getString("z"));
		}
	};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (getLinearAcelSensors() == null) {
			hassensor = false;
			Toast.makeText(this, "No Linear Acceleration Sensors Available",
