...
public class SensorGyro extends Activity implements SensorEventListener {
	...
	private final Handler gyroEventHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			((TextView) findViewById(R.id.gyroxtext)).setText(data
					.getString("x"));
			((TextView) findViewById(R.id.gyroytext)).setText(data
					.getString("y"));
			((TextView) findViewById(R.id.gyroztext)).setText(data
					.getString("z"));
			((TextView) findViewById(R.id.gyrodxtext)).setText(data
					.getString("dx"));
			((TextView) findViewById(R.id.gyrodytext)).setText(data
					.getString("dy"));
			((TextView) findViewById(R.id.gyrodztext)).setText(data
					.getString("dz"));
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (getGyroSensors() == null) {
			hassensor = false;
			Toast.makeText(this, "No Gyroscopic Sensors Available",
