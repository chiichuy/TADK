...
public class SensorRotationVector extends Activity implements
		SensorEventListener {
	...
	private final Handler rotvectEventHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			((TextView) findViewById(R.id.rotxtext)).setText(data
					.getString("x"));
			((TextView) findViewById(R.id.rotytext)).setText(data
					.getString("y"));
			((TextView) findViewById(R.id.rotztext)).setText(data
					.getString("z"));
		}
	};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (getRotVectorSensors() == null) {
			hassensor = false;
			Toast.makeText(this, "No Rotational Vector Sensors Available",
