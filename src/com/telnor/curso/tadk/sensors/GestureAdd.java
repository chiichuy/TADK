...
public class GestureAdd extends Activity implements
	...
	private boolean storeGesture() {
		if (gesture != null) {
			...
			if (name == null || name.trim().length() < 1) {
				Toast.makeText(this, "You must provide a name",
			...
			Toast.makeText(this, "You must make a gesture", Toast.LENGTH_SHORT)
					.show();
		return false;
	}
}
