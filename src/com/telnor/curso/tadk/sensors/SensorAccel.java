...
public class SensorAccel extends Activity implements SensorEventListener {
	...
	private final Handler accelEventHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			((TextView) findViewById(R.id.accelxtext)).setText(data
					.getString("x"));
			((TextView) findViewById(R.id.accelytext)).setText(data
					.getString("y"));
			((TextView) findViewById(R.id.accelztext)).setText(data
					.getString("z"));
		}
	};
