...
public class UsuarioContentProvider extends ContentProvider {
	...
	private static final String uri = "content://com.telnor.curso.tadk.contentprovider.usuariocontentprovider/usuario";
	...
	static {
		...
		uriMatcher.addURI("com.telnor.curso.tadk.contentprovider", "usuario",
				USUARIOS);
		uriMatcher.addURI("com.telnor.curso.tadk.contentprovider", "usuario/#",
				USUARIOS_ID);
	}
	...
	public boolean onCreate() {
		...
		usuariosHelper = new UsuarioSqliteHelper(getContext(), BD_NOMBRE, null,
				BD_VERSION);
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		Cursor c = db.query(TABLA_USUARIO, projection, where, selectionArgs,
				null, null, sortOrder);
